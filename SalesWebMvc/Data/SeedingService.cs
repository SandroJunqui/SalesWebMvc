...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            if(_context.Department.Any() || // verifica se a tabela esta vazia
                _context.Seller.Any() ||
                _context.SalesRecord.Any())
            {
                return; // DB has been seeded    banco de dados ja foi populado
            }
            ...
            _context.Department.AddRange(d1, d2, d3, d4);   // adicionando no bd
            ...
            _context.SaveChanges(); // salvar varios registros no bd
        }
    }
}